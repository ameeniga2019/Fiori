sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("ZAMR-app/Zamr-app/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("ZAMR-app.Zamr-app.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ZAMR-app/Zamr-app/localService/mockserver"], function (mockserver) {
