sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("ZAMR-app.Zamr-app.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias ZAMR-app.Zamr-app.controller.ListSelector
			 */
			 ...
			 * @return {ZAMR-app.Zamr-app.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
