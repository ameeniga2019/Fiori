/*global history */
sap.ui.define([
		"ZAMR-app/Zamr-app/controller/BaseController",
		"sap/ui/model/json/JSONModel",
		"sap/ui/model/Filter",
		"sap/ui/model/FilterOperator",
		"sap/m/GroupHeaderListItem",
		"sap/ui/Device",
		"ZAMR-app/Zamr-app/model/formatter",
		"ZAMR-app/Zamr-app/model/grouper",
		...
		return BaseController.extend("ZAMR-app.Zamr-app.controller.Master", {
			...
			onSearch : function (oEvent) {
				...
				if (sQuery) {
					this._oListFilterState.aSearch = [new Filter("Mtart", FilterOperator.Contains, sQuery)];
				} else {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("ZAMR-app.Zamr-app.view.ViewSettingsDialog", this);
			...
			onConfirmViewSettingsDialog : function (oEvent) {
				...
				aFilterItems.forEach(function (oItem) {
					switch (oItem.getKey()) {
						case "Filter1" :
							aFilters.push(new Filter("Ntgew", FilterOperator.LE, 100));
							break;
						case "Filter2" :
							aFilters.push(new Filter("Ntgew", FilterOperator.GT, 100));
							break;
						default :
							break;
					}
